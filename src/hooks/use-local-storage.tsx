...
export function useLocalStorage<TDefault extends Record<string, any>>(key: TKey, initialState: TDefault): IUseLocalStorage<TDefault> {
...
export const getStorage = <TValue extends Record<string, any>>(key: TKey): TValue | null => {
...
export const setStorage = <TValue extends Record<string, any>>(key: TKey, value: TValue) => {
	try {
